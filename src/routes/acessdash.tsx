    ...
    <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
      ...
      {isNotQualified && (
        <a
          ...
          rel="noopener noreferrer"
          onClick={() => onContact?.()}
          title="Enviar detalhes do Network Master (quando disserem Sim)"
          className="inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs font-medium transition-transform hover:scale-105 active:scale-95 bg-purple-500/20 text-purple-400 hover:bg-purple-500/30"
        >
          {waIcon}
          Enviar Oferta NM
        </a>
