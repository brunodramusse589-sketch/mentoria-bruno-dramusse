...
function PerfilQualificado() {
  return (
    <div className="pt-10 text-center">
      <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-full bg-[#22c55e] shadow-[0_0_60px_rgba(34,197,94,0.45)]">
        <svg width="44" height="44" viewBox="0 0 24 24" fill="#fbbf24" stroke="#f59e0b" strokeWidth="1" strokeLinejoin="round">
          <polygon points="12,2 15,9 22,9.5 17,14.5 18.5,22 12,18 5.5,22 7,14.5 2,9.5 9,9" />
        </svg>
      </div>
      <h1 className="text-[36px] leading-[1.1] font-black tracking-tight sm:text-5xl">
        Perfil Qualificado
      </h1>
      <p className="mx-auto mt-6 max-w-xl text-[17px] leading-[1.55] text-white/70 sm:text-lg">
        Seu perfil demonstrou o exato alinhamento que buscamos. O próximo passo é uma conversa rápida.
      </p>
      <div className="mt-10 flex items-center justify-center">
        <a
          href="https://wa.me/258856075042?text=Salve%20Bruno!%20Tenho%20interesse%20na%20vaga%20da%20mentoria%20individual."
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-3 rounded-full bg-[#22c55e] px-7 py-4 text-[16px] font-semibold text-black transition-transform hover:scale-[1.02] active:scale-[0.98]"
        >
